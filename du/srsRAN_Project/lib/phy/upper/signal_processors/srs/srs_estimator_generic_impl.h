...
/// Callback function type for SRS data notifications
using srs_e2_callback_t = std::function<void(uint32_t rnti, 
                                             uint32_t antenna_id,
...
public:
  ...
  /// Set E2 callback for SRS data reporting
  void set_e2_callback(srs_e2_callback_t callback) {
    e2_callback_ = std::move(callback);
  }
...
private:
  ...
  /// E2 callback for SRS data notification
  srs_e2_callback_t e2_callback_;
};
